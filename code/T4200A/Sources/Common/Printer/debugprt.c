...
//! Local buffer for AQTAB/ISTAB/CRTAB records (the size is set to max of the three)
static UBYTE LOCBUF[AQSZE];
//! Pointer to AQTAB record
static struct acquirer_rec * pAcqPtr;
//! Pointer to ISTAB record
static struct issuer_rec * pIssPtr;
//! Pointer to CRTAB record
...
//-----------------------------------------------------------------------------
//! \brief
//!     Prints a message from the Multilingual table
//!
//! \param
//!		[in]msgid			Message id to be printed
//!
//! \return
//!     None
//!
//! \note
//!     Use LineBuffer to get and print the message.
//-----------------------------------------------------------------------------
static void PrintMsg( enum msg_id msgid )
{
...
//-----------------------------------------------------------------------------
//! \brief
//!     Prints Send and Receive Buffers
//!
//! \return
//!     None
//-----------------------------------------------------------------------------
