...
#define TC3_REFPERMIT   0x01    // refund iþlemine izin ver 
#define TC3_PAUTHPERMIT 0x02    // Preauth Permitted 
#define TC3_CLPREPERMIT 0x04    // Closed Preauth iþlemine izin ver 
...
#define TC4_INSPERMIT   0x10    // Installment iþlemine izin ver 
...
{    
    ...
    UBYTE TCACTDT2[4];                  
    UBYTE TCCURCD1[3];                  
    UBYTE TCCURSIGN1[S_TCLEADC];    
    UBYTE TCCURCD2[3];                                  
    UBYTE TCCURSIGN2[S_TCLEADC];                
...
struct acquirer_rec
{
    ...
    UBYTE AQRESV[15];           // Reserved for future development
    ...
    UBYTE AQSCUADDRESS[3]; // CU address for HLAN connection
    UBYTE AQOPT7;
    UBYTE AQTPIPID;
    UBYTE AQTSIPID;
...
struct trandata_rec
{
    ...
    UBYTE TRLTSTAN[S_TRSTAN];        // Parsian Stan Added for search with stan and last tran stan
...
/*  ###################################################### */
    ...
    // To support Jalali Calendar
    //UBYTE TRJALALIDATE[S_TRDATE];     // DATE, TRANSACTION (BCD) ** ORDER
    //UBYTE TRJALALIYEAR[S_TRYEAR];     // TRANSACTION YEAR
...
#define R_REVAPPROVED 0x10      // Parsian icin.... Approval for Reversal Trans.
...
struct jrnfind_rec
{
    ...
    UBYTE JSSTAN[S_TRSTAN];     // STAN                 0000000 IS ANY
