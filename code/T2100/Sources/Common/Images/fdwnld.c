...
//-----------------------------------------------------------------------------
//  FileDownLoad        File download function
//
//  Parameters:         None
//
//  Global Inputs:      None
...
//-----------------------------------------------------------------------------
//  XModemMultFilDwnLoad    Perform multiple Xmodem file download
//
//  Parameters:             RS232BAUDRATE baudRate
//
//                          baudRate -- baud rate: rb_19200 -- 19200, 
//                          rb_9600 -- 9600, rb_4800 -- 4800, rb_2400 -- 2400,
//                          rb_1200 -- 1200, rb_300 -- 300
//
//  Global Inputs:          None
//
//  Returns:                Nothing
...
//-----------------------------------------------------------------------------
//  ByteOut         Sends 1 byte to serial port
//
//  Parameters:     UBYTE  sendbyte     byte to be sent
//
//  Global Inputs:  None
//
//  Returns:        OS_RETURN_VALS
//
//  Notes:          Assumes RS232 port previously open.
//-----------------------------------------------------------------------------
...
//-----------------------------------------------------------------------------
//  chksum          find checksum of given buffer
//
//  Parameters:     UBYTE *str      data buffer
//
//                  UWORD len       length of buffer
//
//  Global Inputs:  None
//
//  Returns:        UBYTE           checksum of buffer
//
//  Notes:
//-----------------------------------------------------------------------------
...
//-----------------------------------------------------------------------------
//  Long2Str        Convert a long int to a string
//
//  Parameters:     char* buf       buffer to place converted value
//
//                  long val        value to convert
//
//  Global Inputs:  None
//
//  Returns:        Nothing
