...
//-----------------------------------------------------------------------------
//  SchdOverride    When any input is received from the user in the idle status. 
//                  If reads each schedule table entry and verifies that 
//                  current time is within scheduled idle minutes to 
//                  scheduled time. The event is cleared from the schedule 
//                  table, because the terminal is too busy to perform the 
//                  scheduled event.
//
//  Parameters:     None.
//
...
//-----------------------------------------------------------------------------
//  SchdIdleTime    Check schedule table entry to see if current time 
//                  is within scheduled idle minutes to scheduled time.
//
//  Parameters:     None.
//
//  Global Inputs:  None.
//
//  Returns:        Bool    True  - Terminal is too busy to perform 
//                                  any scheduled Event,
//                          False - otherwise.
//
//  Notes:          None.
