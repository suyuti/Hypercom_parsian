...
extern void Schedule( void )
{
		  ...
		  pSchedulePtr++ )
	{
		...
		{
			// Program yükle komutu geldiyse buraya dallanýr , ancak 
                        // program yüklemyi desteklemiyoruz 
...
static Bool ProcessDLL( void )
{
	...
	// Program yükleme olarak set edildiyse 
	...
	else // parametre yükleme olarak set edildiyse
	{
