...
const struct resp_rec ResponseTab[] = {
	...
	{"04", "", 0, 0},
	{"05", "", 0, 0},	
	{"08", "", R_APPROVED, 0}, // @aydeniz -- BKM 
	{"11", "", R_APPROVED, 0}, // @aydeniz -- BKM 
	{"12", "", 0, 0},
	{"13", "", 0, 0},
	{"14", "", 0, 0},
	{"15", "", 0, 0},
        {"25", "", R_APPROVED, 0}, // Reversal not match but OK ( for Parsian )
        {"30", "", 0, 0},
        {"33", "", 0, 0},
        {"34", "", 0, 0},  
        {"35", "", R_APPROVED, 0}, // Reversal not match but OK ( for Parsian )
        {"38", "", 0, 0},
	{"41", "", 0, 0},
	{"43", "", 0, 0},
	{"51", "", 0, 0},	
	...
	{"ND", "", R_NOCLRREV + R_NOCLRPEND, 0},
        ...
        { "UC", "", R_NOCLRREV+R_NOCLRPEND,   0 },	//@pl MAKE_EMV
        { "NL", "", 0,                        0 },

#ifdef	MAKE_EMV
    { "ME", "", R_NOCLRREV + R_NOCLRPEND,   0 },
...
//-----------------------------------------------------------------------------
//  ResponseTabSize Returns the number of entries defined in ResponseTab.
//
//  Parameters:     None.
//
//  Global Inputs:  ResponseTab
//
//  Returns:        UWORD   Number of entries in ResponseTab.
//
//  Notes:          None.
//
//-----------------------------------------------------------------------------
...
//-----------------------------------------------------------------------------
//  GETMSG          Retrieve a message and store it in MLBuffer
//
//  Parameters:  MSGID = id of message
//
//  Returns:        None
//
//  Notes:          On entry:          
...
//-----------------------------------------------------------------------------
//  GetRspTxtOpts   Get Response Text and Options for this RSPC code
//
//  Parameters:     None
//
//  Global Inputs:
...
//  Returns:        None
//
//  Notes:          Data Passed via RSPCODE, RSPTEXT, etc.
//
//-----------------------------------------------------------------------------
...
//-----------------------------------------------------------------------------
//  ShowErrMsg      Display an error message and wait for 2 seconds
//
//  Parameters:     None
//
//  Global Inputs:  
...
//-----------------------------------------------------------------------------
//  ShowInfoMsg     Display an informational message
//
...
//-----------------------------------------------------------------------------
//  ShowIcePak      Display just an informational message or IcePak 
//                  image  + informational message
//
//  Parameters:     init    image_index - index of Icepak image to display
//
//  Global Inputs:
//
//  Returns:        None
