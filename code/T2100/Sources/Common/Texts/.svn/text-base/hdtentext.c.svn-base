...
const char *const EnglishMessages[] = {
	...
	"IP Configuration",			// EnterIpConfig
	"NMS Dest. IP Address",		// EnterNMSIp
	"NMS Dest. Port Number",	// EnterNMSPort
	"Init Dest. IP Address",	// EnterInitIp
	"Init Dest.Port Number",	// EnterInitPort
	"Local IP Address",			// EnterLocalIp
	"Local Subnet Mask",		// EnterLocalSubnet
	"Gateway IP Address",		// EnterLocalGateway
	...
	"QUIT",						// N_QUIT
	"NEXT",						// N_NEXT
	"SWIPE CARD",     // N_SwipeOrInsertCard
	"X",						// N_X
	"CONTINUE",					// N_Continue
	"KEY",						// N_KEY
	"PASSED",					// N_Passed
	...
	"ACCEPTED",                 // Accepted
        ...
        "DECLINED",		// DeclinedMsg           //@A - BC
        "RESULT",		// ResultMsg             //@A - BC
        "EASY ENTRY",		// EasyEntry             //@A - BC
        "MNDTY DATA MISSING",   // MndtyDataMissing      //@A - BC
...
#ifdef MAKE_KIB
        "LOYALTY",                                 // N_LoyaltyInquiry,
        "LOYALTY LIST",                            // N_LoyaltyList
        "SALE-LOYALTY",                            // N_SaleWithLoyalty
        "LOYALTY AMOUNT",                          // LoyaltyAmountEnt
        "NOT PERMIT",                              // Msg_NotPermitLoyIns
        "INST.-LOYALTY",                           // N_InstallmentWithLoyalty
        "DISCOUNT",                                // N_Discount
        "DISCOUNT SALE",                           //  N_DiscountSale
        "DISCOUNT INST.",                          //  N_DiscountInst
        "ENTER RATE:",                             // N_RateEntry
        "OVER DISCOUNT",                           // Msg_OverDiscount
        "S.POINT   ",                              // N_point max=9
        "DSC ",                                    // N_Disc max= 4
#endif       
...
//-----------------------------------------------------------------------------
//  HdtTextEn_init  Add HDT and pinpad English messages tables for DML support 
//
//  Parameters:     None
//
//  Global Inputs:
