...
static const char *const PclEnText3[] = 
{
	"TYPE",								// Type
	"COUNT",							// Count
	...
	"D. Credit",						// YiKredi
	"I. Visa Credit",					// YdVisaKredi
	"I. Euro Credit",					// YdEuroKredi
	"D. Debit",							// YiDebit
	"I. Debit",							// YdDebit
	"SALE",								// Sale
	"REFUND",							// Refund
	...
	// Successfull Txt
	"Settlement is done Successfully",	// SucSettle
	...
	"Not: ",
	"D. means 'Domestic'",
	"I. means 'International'",
	"2. RECEIPT",
	"IT'S OF CARDHOLDER.",
	"SIGNATURE : ",
	".: BY ENTER PIN :.",
	"YOU MAKE SECURE TRANSACTION",
	"THANKS",
	...
	"INSTALLMENT DETAILS",           // Installs
	"FIRST BILLING DATE: ",			 // FirstBillDate
    "APP LABEL:",                    // AppLbl
	"EXP:",							 // ExpDate
	"CARD NUMBER",					 // CardNumber
	"INITIALIZE COMPLETED",			 // Initialize
	"SUCCESSFULLY",					 // Success
        ...
        "NOTE 2",                                 // Note2 
        "NOTE 3",                                 // Note3 
        "Smart Total",                            // SmartTotal,
        "Smartcard Discount",                     // SmartDiscount,
        "Advantage %",                            // Advantage,
...
extern void PclTextEn_Init( void )
{
	...
	if( TableItemCount != ( sizeof( PclEnText3 ) / sizeof( char * ) ) )
	{
		strcpy( Dspbuf, "PclEnText3" );
		strcat( Dspbuf, MsgSizeMismatch );
	...
	TextIndexAddTable( pcltext_servusDef_id, LNG_EN, PclEnText3, pgnum );
}
