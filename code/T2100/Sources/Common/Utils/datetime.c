...
//  Returns:        None
//
//  Notes:          Month string is stored in global buffer CSTMSG5.
//
//-----------------------------------------------------------------------------
...
//-----------------------------------------------------------------------------
//  FormatDateTime      Format the Date & Time string and store in user buffer
//
//  Parameters:     None
//
//  Global Inputs:
...
//  Returns:        None
//
//  Notes:          Formatted string stored in global buffer CSTMSG5.
//
//-----------------------------------------------------------------------------
...
//-----------------------------------------------------------------------------
//  RptDateTime     Convert the date and time to ASCII and return in CSTMSG5
...
//  Returns:        None
//
//  Notes:          Moved from PRINT.C and made cross-callable so that the month
