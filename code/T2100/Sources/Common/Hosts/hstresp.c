...
//-----------------------------------------------------------------------------
//  HostResp        Check Host Response
//
//  Parameters:     OS_RETURN_VALS  CommReturn      Host Comm function return
//                                                  status.
//
//  Global Inputs:
//
//  Returns:+        Bool    True -  Host Response received okay
//                          False - Host Response not received okay
//
//  Notes:
//
//-----------------------------------------------------------------------------
...
//-----------------------------------------------------------------------------
//  GetErrResp      Get Host Error Response
//
//  Parameters:     OS_RETURN_VALS CommReturn       Host Comm function return
//                                                  status
//
//                  struct trandata_rec *TRLOC      pointer to Transaction Data.
//
//  Global Inputs:
//
//  Returns:        None
...
extern void GetErrResp( OS_RETURN_VALS CommReturn,
