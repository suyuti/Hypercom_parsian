...
extern void RespDisplay( void )
{
	...
	if ( TRINP.TRHOSTTEXT[0] > 12 )
	{
		// Yes; see if second line 
		if ( TRINP.TRHOSTTEXT[20] > 12 )
		{
...
//-----------------------------------------------------------------------------
//	BalanceRespDisplay	Display Response to Balance Inquiry.
//
//	Parameters: 		None.
//
//	Global Inputs:		None.
...
//-----------------------------------------------------------------------------
//	RespDisplayHostText2	Display Host Text - 2 lines
//
//	Parameters: 			None.
//
//	Global Inputs:			TRINP.TRHOSTTEXT.
//
//	Returns:				Nothing.
//
//	Notes:					Display first 20 characters in first line,
//							second group of 20 characters in second line.
//
//-----------------------------------------------------------------------------
...
//-----------------------------------------------------------------------------
//	RespDisplayHostText1	Display Host Text - 1 line
//
//	Parameters: 			None.
//
//	Global Inputs:			TRINP.TRHOSTTEXT.
...
//-----------------------------------------------------------------------------
//	RespDisplayStatus	Display Transaction Status.
//
//	Parameters: 		None.
//
//	Global Inputs:		None.
...
//-----------------------------------------------------------------------------
//	RespDisplayText	Display Host Response.
//
//	Parameters: 	None.
//
//	Global Inputs:	TRINP.TRRSPTXT.
//
//	Returns:		Nothing.
//
//	Notes:			None.
...
static void RespDisplayText( void )
{       
        // Host Display Data varsa basýlýr.. 
        if ( !NullComp(HSTDISPDATA,sizeof(HSTDISPDATA)) ) 
        {            
              memcpy(CSTMSG, TRINP.TRRSPTXT, S_TRRSPTXT );
              CSTMSG5[S_TRRSPTXT] = '\0';

              MoveIt( CSTMSG3, HSTDISPDATA, 16);
              CSTMSG3[16] = 0x00;
              MoveIt( CSTMSG4, &HSTDISPDATA[16], 16);
              CSTMSG4[16] = 0x00;

              CSTMSG2[0] = 0x00;
              CSTMSG5[0] = 0x00;
              DrawScreen( SHOW_INFO_SCR ); 
