...
#define RSP00		"00"
#define RSP00_OUR	"00"		// APPROVED
#define RSP85		"85"
#define RSP85_OUR	"00"		// NO REASON TO DECLINE
#define RSPN7		"N7"
#define RSPN7_OUR	"79"		// CVV2 MISMATCH
...
static UBYTE RspCode[2];		// Temporary response code
...
//-----------------------------------------------------------------------------
//	RspVisaD		Handle Visa D Response.
//
...
//-----------------------------------------------------------------------------
//	RspUnPackVisaD	Unpack the Visa D response.
//
//	Parameters: 	None.
//
//	Global Inputs:	None.
...
//-----------------------------------------------------------------------------
//	RspUnPackAuth	Unpack the Visa D response.
//
//	Parameters: 	None.
//
//	Global Inputs:	None.
...
//-----------------------------------------------------------------------------
//	TranslateRspCode	TRANSALATE VISANET BASE II RESPONSE
//						CODES INTO OUR RESPONSE CODES
//
//	Parameters: 		None.
//
//	Global Inputs:		None.
...
//-----------------------------------------------------------------------------
//	RspUnPackSettle	Unpack the Visa D Settlement response.
//
//	Parameters: 	None.
//
//	Global Inputs:	None.
