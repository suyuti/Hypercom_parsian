...
//-----------------------------------------------------------------------------
//	TerminalSetup	Entry point for setting up terminal.
//
//	Parameters: 	None.
//
//	Global Inputs:	None.
		...
		if ( 2 == Status )
		{
			...
			if ( InputPswd( N_Terminal ) )
			{
				if((TERM.TERMOpt3 & TM3_HWTYPE_MASK) == TM3_ETHERNET)
					CurrentEvent.NEXTEVENT = MENU_TERM_SETUP_IP;
				else
...
//-----------------------------------------------------------------------------
//	PaperFeed		Performs line feeds as required.
//
//	Parameters: 	None.
//
//	Global Inputs:	None.
...
//-----------------------------------------------------------------------------
//	SetContrast		Screen to set display contrast, also sets global 
