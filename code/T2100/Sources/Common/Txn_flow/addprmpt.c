...
//-----------------------------------------------------------------------------
//  AdditionalPrompt    Perform additional prompt processing
//
//  Parameters:         None
//
//  Global Inputs:
//
//  Returns:            char    0 - bad entry
...
//-----------------------------------------------------------------------------
//  ChkPromptEnable     Check if additional prompt is enabled
//
//  Parameters:         None
//
//  Global Inputs:
//
//  Returns:            char    0 - additional prompt is disabled
...
//-----------------------------------------------------------------------------
//  SaveAPdata      Save the user entered additional data
//
//  Parameters:     None
//
//  Global Inputs:
//
//  Returns:        int     Index of the additional prompt.
//
//  Notes:
//
//-----------------------------------------------------------------------------
