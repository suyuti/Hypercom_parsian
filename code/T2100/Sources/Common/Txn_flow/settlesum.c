...
//-----------------------------------------------------------------------------
//  SettleSumRpt        Print the Settlement Status Report
//
//  Parameters:         None
//
//  Global Inputs:      None
...
//-----------------------------------------------------------------------------
//  ViewSettleSum       View the Settlement Status Report.
//
//  Parameters:         None
////
//  Global Inputs:      None
...
//-----------------------------------------------------------------------------
//  PrepPages           Space fill then NULL terminate each custom buffer.
//
//  Parameters:         None
//
//  Global Inputs:      None
...
//-----------------------------------------------------------------------------
//  PlaceData           This function will take the data in the custom buffer
...
//
//  Parameters:         char * pBuf     Pointer to the custom buffer to place
//                                      data in.
//
//                      UBYTE Form      Format of the placement, right, left
//                                      or center
//
//  Global Inputs:      None
//  
