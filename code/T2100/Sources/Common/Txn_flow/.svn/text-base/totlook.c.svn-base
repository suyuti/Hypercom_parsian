...
//-----------------------------------------------------------------------------
//  GetNextIssuer   Get the next issuer based upon direction.
//
//  Parameters:     None.
//
//  Global Inputs:  Direction.
//
...
//-----------------------------------------------------------------------------
//  IncIssuer       Increment Issuer Index.
//
//  Parameters:     None.
//
//  Global Inputs:  None.
...
//-----------------------------------------------------------------------------
//  DecIssuer       Decrement Issuer Index.
//
//  Parameters:     None.
//
//  Global Inputs:  None.
...
//-----------------------------------------------------------------------------
//  DoNoMoreTotals  Indicates if more totals.
//
//  Parameters:     None.
//
//  Global Inputs:  TotalsFound.
//
//  Returns:        Bool    True  - Totals have been found,
//                          False - otherwise.
//
//  Notes:          None.
//
...
//-----------------------------------------------------------------------------
//  BuildDisplay    Build Totals Display.
//
//  Parameters:     None.
//
...
//  Returns:        Nothing.
//
//  Notes:          Updates CSTMSG, CSTMSG2, CSTMSG3, CSTMSG4 and CSTMSG5.
//
//-----------------------------------------------------------------------------
...
//-----------------------------------------------------------------------------
//  BuildGrandTotal Build Grand Totals
//
//  Parameters:     None.
//
//  Global Inputs:  None.
