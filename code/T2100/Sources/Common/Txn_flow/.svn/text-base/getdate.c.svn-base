...
//-----------------------------------------------------------------------------
//  GetDate         Get a date entry from the keyboard
//
//  Parameters:     const ENTRY_STR * es    Pointer to entry screen structure
//
//                  Bool yearRequired       boolean to say if year entry is 
//                                          required
//
//  Global Inputs:
//
...
//-----------------------------------------------------------------------------
//  validDate       Validate the date in Dspbuf
//
//  Parameters:     None
//
//  Global Inputs:
//
//  Returns:        Bool    True if valid date entered (in Dspbuf, MMDDYY)
//                          False otherwise
//  Notes:
//
//-----------------------------------------------------------------------------
