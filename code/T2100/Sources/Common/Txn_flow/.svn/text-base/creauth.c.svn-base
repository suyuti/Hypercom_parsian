...
//-----------------------------------------------------------------------------
//  CalcReauth      Calculate Amount+Reauth Percentage
//
//  Parameters:     UBYTE * pResult     pointer to 6-byte BCD Result Amount
//
//                  UBYTE * pAmount     pointer to 6-byte BCD Initial Amount.
//
//  Global Inputs:
//
//  Returns:        None
