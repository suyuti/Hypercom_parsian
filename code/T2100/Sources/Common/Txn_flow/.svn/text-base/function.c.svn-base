		...
		{		
			...
			case 18:
				...
				return;			
                        ...
                        // invoice numarasýný girerek batchte bulunan bir kaydý görme 
			case 21:
				Fun_21(  );		
				return;			
                        
                        // sliplerin ve raporlarýn 4 satýrýný girme 
			case 26:
				Fun_26(  );		
				return;			
			...
			case 32:
				...
				return;
                        ...
                        // Ayrýntýlý EMV Raporlarý ile iþlem gerçekleþtirme
			case 37:
				Fun_37(  );		// Toggle EMV debug printing
				return;
                        
                        // RSA Key tablosunun basýmý 
                        case 38:
				PrintKeyTable(  );    // Print RSA key table
				return;
#endif	// MAKE_EMV

                        // parametre yükleme iþleminin maksimum deneme sayýsýný deðiþtirme 
                        case 54: 
			...
			case 65:
				...
				return;
                        ...
                        // Yazýcýnýn inaktif ve aktif edilmesi 
			case 71:
				Fun_71(  );		// Printer Enable/Disable
				return;

                        
                        // Son iþleme ait slibin tekrar basýmý 
			case 72:
				JrnReprintLast ();
				return;
                        
                        // Herhangi bir iþlemin slibinin tekrar basýmý 
			case 73:
				JrnReprintAny ();
				return;
			...
			case 89:
				...
				return;
                        ...
                        // Þifre deðiþtirme (þifre deðiþiklikleri bir sonraki parametre yükleme 
                        // iþlemine kadar geçerlidir.)
			case 90:
				Fun_90(  );		
				return;
                        
                        // Yazýlým bilgilerinin gösterimi 
			case 91:
			...
			case 94:
				...
				return;
                        ...
                        // Yerel seçeneklerin deðiþimi ( þifre ) 
			case 97:
				Fun_97(  );		
				return;
                        
                        // baðlantý ayarlarýnýn deðiþtirilmesi 
			case 98:
				Fun_98(  );		
				return;
                        
                        // bazý özel fonksiyonlarý içerir (batch temizleme , reversal silme vb)                  
			case 99:
				Fun_99(  );		
				return;
