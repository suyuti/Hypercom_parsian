...
//-----------------------------------------------------------------------------
//  GetAQID         Get acquirer ID.
//
//  Parameters:     Bool        SelectAll - allow selection of all acquirers:
//                                          True  - Yes
//                                          False - No.
//
//  Global Inputs:
//
//  Returns:        Bool    True  - Acquirer set
//                          False - Acquirer not set.
//
//  Notes:          Need to add support for MENU and Settle
//
//-----------------------------------------------------------------------------
