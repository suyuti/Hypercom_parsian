...
//-----------------------------------------------------------------------------
//  AmountEntry     Accept user input for amount entry
//
//  Parameters:     ENTRY _STR *pEntry  Pointer to user buffer to store, 
//                                      display line and flag indicating
//                                      whether zero amount is allowed plus a
//                                      flag for amount entry size.
//
//                  UBYTE Zero_OK       If ZERO_OK is set to 1, zero amount is
//                                      allowed.Otherwise zero amount is not
//                                      allowed.
//
//                  UBYTE IO_Settle_Amt If IO_Settle_Amt is one then use settle
//                                      sized amount.Otherwise us standard sized
//                                      amount. 
//
//  Global Inputs:
//
//  Returns:        UBYTE       0 - CANCEL key was pressed
