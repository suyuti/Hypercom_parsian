...
//-----------------------------------------------------------------------------
//  TrinpClear      Clear Transaction Input Fields.
//
//  Parameters:     None.
//
//  Global Inputs:  None.
...
extern void TrinpClear( void )
{
	...
	// Clear Additional Host Print Data Buffer and host Display Data Buffer 
	memset( ( UBYTE * ) & HSTPRDATA, 0, S_HSTPRDATA );
        memset( ( UBYTE * ) & HSTDISPDATA, 0, S_HSTDISPDATA );
...
extern void ClearTransactionVariable( void ) 
{
  flagPreCancel = 0;
}
//=============================================================================
