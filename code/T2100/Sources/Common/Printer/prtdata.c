...
//-----------------------------------------------------------------------------
//  PrintData       Print a raw (HEX) Data Structure
//
//  Parameters:     enum msg_id Title       label for the data print, NULL for
//                                          default label
//
//                  UBYTE * Data            pointer to the data
//
//                  UBYTE Length            length of the data
//
//                  Bool FormFeed           perform a form feed if True; 
//                                          otherwise, perform a line feed at
//                                          the end of printing.
//
//  Global Inputs:
//
//  Returns:        None
//
//  Notes:          Assumes that the caller will handle the printer
//                  open and close. Length of the data <= 255 bytes.
//
//-----------------------------------------------------------------------------

void PrintData( enum msg_id Title, UBYTE * pData, short Length,
					   Bool FormFeed )
{
	UBYTE MaxChars;
	short PrintChars;
