...
#define TRACE_COM1          0x01	// USE RS232
#define TRACE_COM2          0x02	// SEND ESC SYMBOL
#define TRACE_LINE          0x04	// SEND EOT SYMBOL
#define TRACE_STATION_RS0   0x08	// HEX LENGTH IN HEADER
#define TRACE_STATION_RS1   0x10	// 0=COM1/1=COM2 
#define TRACE_STATION_RS2   0x20	// FC on\off
...
struct rs232_rec
{
	...
	UBYTE BTPairingMode;        // BT Pairing Mode
    UBYTE TraceMask;            // Trace mask
    UBYTE RSRESV[21];			// RESERVED
