...
#define S_HSTPRDATA	120			// Length of Additional Host Print Data
#define S_HSTDISPDATA	32			// Length of Additional Host Print Data
...
extern short pcltext_servusDef_id;              // -- BC
...
extern struct settletotals_rec SETTLETOTALS;	// Settle totals @ydeniz -- BC 
...
extern char HSTDISPDATA[S_HSTDISPDATA];    // Additional Host Display Data @ydeniz -- BC -- 
...
//extern UWORD B60SBytesLeft;			// Bytes left in subfield             
...
extern PINDATA*	PIN_CONFIG;				/* Pointer to PIN device configuration parameters */
...
extern Bool FirstGenACAdviceRequired;    // @A - BC 22/11/2006 
extern Bool SecondGenACAdviceRequired;   // @A - BC 22/11/2006 
extern Bool ForcedAccept;                // @A - BC 22/11/2006 
extern UBYTE TAIDTABIndex;               // @A - BC 23/11/2006 
#endif // MAKE_EMV
...
extern UBYTE RefundDate[8];    // @ydeniz -- BC -- 
extern UBYTE flagPreCancel;    // @ydeniz -- BC -- 
extern Bool flagSettle;       // @ydeniz -- hemen settlement gerekli manasýnda ;) 
extern UBYTE PayPlanNum;      // taksitli için kullanýlacak BC 

extern char HstDispData[36];			//@ydeniz -- BC -- 
extern char HstPrintData[120];			//@ydeniz -- BC -- 
extern UBYTE AppLabel[34];
extern UBYTE instnum[2];
extern UBYTE ekstreamount[6];	
extern UBYTE billingdate[8];
extern UBYTE   EncPin[13];         //  -ENCRYPTED PIN BLOCK for S9PinPad 
