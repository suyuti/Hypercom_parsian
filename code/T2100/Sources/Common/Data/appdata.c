...
char HSTDISPDATA[S_HSTDISPDATA];    // Additional Host Display Data @ydeniz -- BC -- 
...
//UWORD B60SBytesLeft;			// Bytes left in subfield             
//#endif // MAKE_CERTIFICATE

Bool OnlineCancelled;			/* online transaction cancelled by user */


PINDATA*	PIN_CONFIG;				/* Pointer to PIN device configuration parameters */
...
Bool FirstGenACAdviceRequired;    // @A - BC 22/11/2006 
Bool SecondGenACAdviceRequired;   // @A - BC 22/11/2006 
Bool ForcedAccept;                // @A - BC 22/11/2006 
UBYTE TAIDTABIndex;               // @A - BC 23/11/2006 
#endif // MAKE_EMV
...
UBYTE flagPreCancel;      // @ydeniz -- BC -- 
Bool flagSettle;          // @ydeniz -- hemen settlement gerekli manasýnda ;) 
UBYTE PayPlanNum;         
UBYTE AppLabel[34];
UBYTE instnum[2];
UBYTE ekstreamount[6];	
UBYTE billingdate[8];
UBYTE   EncPin[13];         //  -ENCRYPTED PIN BLOCK for S9PinPad 
