...
//-----------------------------------------------------------------------------
//  Review          Process review transaction
//
//  Parameters:     None
//
//  Global Inputs:  None
...
//-----------------------------------------------------------------------------
//  Find                Process review transaction starting with a
...
//-----------------------------------------------------------------------------
//  ReviewCommon        Process common part of review and find.
//
//  Parameters:         None
//
//  Global Inputs:      None
...
//-----------------------------------------------------------------------------
//  ShowBatch           Format the batch number display into CSTMSG
//
//  Parameters:         None
//
//  Global Inputs:      None
...
//-----------------------------------------------------------------------------
//  JournalShow         Display 2 lines of information, group 1, 2, or 3.
//
//  Parameters:         UBYTE group     Group number, 1, 2 or 3
//
//  Global Inputs:      None
//
//  Returns:            Nothing
...
static void JournalShow( UBYTE group )
{
	...
	{		
		...
		CvtAmtYTL( ( char * ) &CSTMSG3[screen_limit - 13 - 3], TRINP.TRTOTAM );
...
//-----------------------------------------------------------------------------
//  SupervisorPassword      Test for password supervisor required.
//
//  Parameters:             UBYTE local_option      Local password option for
//                                                  this transaction
//
//                          UBYTE transaction_name  This transaction name
//
//  Global Inputs:          None
//
//  Returns:                Bool   True  - if password OK or previously entered.
//                                 False - if void or reversal set in journal
//                                         or no pswd.
//  Notes:
//-----------------------------------------------------------------------------
