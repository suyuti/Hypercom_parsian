...
#define EMVL2_DOL_MAX      252 // Maximum permitted size of DOL buffer

#ifdef _TARG_Z80               // Size of DDF and ADF stores 
#define EMVL2_DF_SIZE        5 // Reduce common memory foorprint for Z80 builds
#else
