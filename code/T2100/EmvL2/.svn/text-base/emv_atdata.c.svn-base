...
UBYTE ADTFMT __init__(=0);  // Table format
__attribute__((section ("adtdata")))
ADTRecType ADTData[EMVL2_ADT_MAX] __init__(={{0}}); // Format + 128 + LRC = 130 bytes x 10 = 1300 bytes
__attribute__((section ("adtdata")))
UBYTE ADTLRC __init__(=0);  // Table LRC
