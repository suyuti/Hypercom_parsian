...
const struct event_entry EVENT_TABLE[] = {
...

	{
	 ...
	 T2_NOPREREV + T2_COMPLETE,	// OPTION BYTE 2
	 T3_NOISNAME,				// OPTION BYTE 3
	 T4_LOGON + T4_NOPINDSP,				// OPTION BYTE 4
	 0},
...

	{
        ...
        ChangeApplication,          // Action handler 
        "",                         // Transaction Name
        0,                          // OPTION BYTE 1
        0,                          // OPTION BYTE 2
		T3_NO_INIT,					// OPTION BYTE 3
...

	{
        ...
        FuncNotSupported, //Trace_Start,                // Action handler 
        "",                         // Transaction Name
        0,                          // OPTION BYTE 1
        0,                          // OPTION BYTE 2
		T3_NO_INIT,					// OPTION BYTE 3
...

	{
        ...
        FuncNotSupported, //Trace_Stop,                 // Action handler 
        "",                         // Transaction Name
        0,                          // OPTION BYTE 1
        0,                          // OPTION BYTE 2
		T3_NO_INIT,					// OPTION BYTE 3
...

	{
        ...
        FuncNotSupported, //Trace_Print,                // Action handler 
        "",                         // Transaction Name
        0,                          // OPTION BYTE 1
        0,                          // OPTION BYTE 2
		T3_NO_INIT,					// OPTION BYTE 3
...

	{
        ...
        FuncNotSupported,//Trace_Send_COM2,            // Action handler 
        "",                         // Transaction Name
        0,                          // OPTION BYTE 1
        0,                          // OPTION BYTE 2
		T3_NO_INIT,					// OPTION BYTE 3
...

	{
        ...
        FuncNotSupported, //Trace_Send_COM1,            // Action handler 
        "",                         // Transaction Name
        0,                          // OPTION BYTE 1
        0,                          // OPTION BYTE 2
		T3_NO_INIT,					// OPTION BYTE 3
...
// @Aydeniz -- BC --
	 ...
	 FuncNotSupported,// Installment,				// Cross-Call action handler
	 "",						// Transaction name
	 0,				// OPTION BYTE 1
	 T2_REFER + T2_FLOOR,		// OPTION BYTE 2
	 T3_CHK_PEND + T3_REV,		// OPTION BYTE 3
	 ...
	 FuncNotSupported,// PrtFormattedDB,			// Cross-Call action handler
	 "",						// Transaction name
	 0,							// OPTION BYTE 1
	 0,							// OPTION BYTE 2
	 0,							// OPTION BYTE 3
...

	{
	 ...
	 FuncNotSupported, // XInputIPCONFIG,			// Cross-Call action handler
	 "",						// Transaction name
	 T1_NORECEIPT,				// OPTION BYTE 1
	 0,							// OPTION BYTE 2
	 T3_NO_INIT,				// OPTION BYTE 3
...

	{
	 ...
	 FuncNotSupported, //XInputNMSIP,				// Cross-Call action handler
	 "",						// Transaction name
	 T1_NORECEIPT,				// OPTION BYTE 1
	 0,							// OPTION BYTE 2
	 T3_NO_INIT,				// OPTION BYTE 3
...

	{
	 ...
	 FuncNotSupported, //XInputNMSPORT,				// Cross-Call action handler
	 "",						// Transaction name
	 T1_NORECEIPT,				// OPTION BYTE 1
	 0,							// OPTION BYTE 2
	 T3_NO_INIT,				// OPTION BYTE 3
...

	{
	 ...
	 FuncNotSupported,//XInputINITIP,				// Cross-Call action handler
	 "",						// Transaction name
	 T1_NORECEIPT,				// OPTION BYTE 1
	 0,							// OPTION BYTE 2
	 T3_NO_INIT,				// OPTION BYTE 3
...

	{
	 ...
	 FuncNotSupported, //XInputINITPORT,				// Cross-Call action handler
	 "",						// Transaction name
	 T1_NORECEIPT,				// OPTION BYTE 1
	 0,							// OPTION BYTE 2
	 T3_NO_INIT,				// OPTION BYTE 3
...

	{
	 ...
	 FuncNotSupported, //XInputLOCALIP,				// Cross-Call action handler
	 "",						// Transaction name
	 T1_NORECEIPT,				// OPTION BYTE 1
	 0,							// OPTION BYTE 2
	 T3_NO_INIT,				// OPTION BYTE 3
...

	{
	 ...
	 FuncNotSupported, //XInputLOCALSUBNET,			// Cross-Call action handler
	 "",						// Transaction name
	 T1_NORECEIPT,				// OPTION BYTE 1
	 0,							// OPTION BYTE 2
	 T3_NO_INIT,				// OPTION BYTE 3
...

	{
	 ...
	 FuncNotSupported, //XInputGATEWAYIP,			// Cross-Call action handler
	 "",						// Transaction name
	 T1_NORECEIPT,				// OPTION BYTE 1
	 0,							// OPTION BYTE 2
	 T3_NO_INIT,				// OPTION BYTE 3
...
//-----------------------------------------------------------------------------
//  EventTableSize  Returns the number of entries defined in EVENT_TABLE.
//
//  Parameters:     None.
//
//  Global Inputs:  EVENT_TABLE
//
//  Returns:        UWORD   Number of entries in EVENT_TABLE.
//
//  Notes:          None.
//
//-----------------------------------------------------------------------------
...
//-----------------------------------------------------------------------------
//	VerifyEventTableSize	Verify the number of entried in EVENT_TABLE
...
//	Returns:		Nothing.
//
//	Notes:			Does NOT return if the size does not match.
//
//-----------------------------------------------------------------------------
