...
#define T1_PRINTTIME            0x20		// NO SYSTEM TIME UPDATE
...
#define T4_LOGON                0x02		// NOT USED AT PRESENT
...
#define TC1_CLPREPERMIT         0x01		// Closed Preauth iþlemine izin ver 
#define TC1_INSPERMIT           0x02		// Installment iþlemine izin ver 
#define TC1_SHOWMSR             0x02		// DISPLAY TRACK 2
#define TC1_REST                0x04		// RESTAURANT PROCESSING
#define TC1_REFPERMIT           0x04		// refund iþlemine izin ver 
...
#define TC1_RESERVED1           0x08		// 
#define TC1_RESERDVED2          0x10		// 
...
#define TC3_PAUTHPERMIT	        0x80	    // Preauth Permitted 
...
#define TC4_MOPERMIT            0x10        // Mail order permitted @Aydeniz - BC 
#define TC4_DUPL                0x20	    // ENABLE CHECKING FOR DUPLICATE TRANSCTN
#define TC4_TRAINING            0x40	    // ENABLED IF TRAINING MODE
#define TC4_OFFPERMIT	        0x80    	// Offline Sale Permitted @Aydeniz - BC 
...
#define TC5_RESERVED            0x10    	// SHIFT PROCESSING ENABLED

#define TC6_PINBYPASSTERM	    0x01        // ALLOW PIN BYPASS (from terminal)
#define TC6_PINBYPASSPIN	    0x02        // ALLOW PIN BYPASS (from pinpad)
#define TC6_PININTERNAL		    0x04        // ALLOW Internal Pinpad
#define TC6_PINEXTERNAL		    0x08        // ALLOW External Pinpad
#define TC6_EARLYAMENTFORICC    0x10        // Early Amount Entry for ICC Txns @erd
#define TC6_LAST4PAN            0x20        // Last 4 of PAN on Cust Copy @erd
#define TC6_DIS2NDRCPT          0x40        // Disable Second Reciept @erd
#define TC6_LONGTIMEOUT         0x80        // Long Timeout @erd
...
#define TC7_CSTM_ACT            0x01        // Customer Activated @erd
#define TC7_PINMSR			    0x02        // MSR attached to external pinpad 
#define TC7_PINSCR			    0x04        // SCR attached to external pinpad
#define TC7_RETAIN_LINK		    0x08        // Retain Link for  sec 
#define TC7_CONF_RPRT           0x10        // Configuration Report
#define TC7_PERMN_IP		    0x20        // Permanent IP conectivity
#define TC7_PRFMS_RPRT          0x40        // Performans Report
#define TC7_RDM_SCNNR_ATTC      0x80        // RDM Scanner attached
...
//                                                          
// @erd 08.12.2006
//		THE FOLLOWING OPTIONS APPLY TO CHECK SERVICE PROMPTS BIT FLAGS 
//      FOR FIRST ELEMENT OF ARRAY

#define S_TCCHECKF_ADDRESS      0x01        // Address
#define S_TCCHECKF_DRVLIC_NO    0x02        // Driver's Lic Number
#define S_TCCHECKF_CHK_NO       0x04        // Check Number
#define S_TCCHECKF_TRANSIT_NO   0x08        // Transit Number
#define S_TCCHECKF_ROUTING_NO   0x10        // Routing Number
#define S_TCCHECKF_LAST4OFACC   0x20        // Last 4 of  Account
#define S_TCCHECKF_ACC_NO       0x40        // Check Account Number
#define S_TCCHECKF_MICR_NO      0x80        // Micr Number

//		FOR SECOND ELEMENT OF ARRAY

#define S_TCCHECKF_EXPDATE      0x01        // Expiration Date MMYY
#define S_TCCHECKF_CARD_NO      0x02        // Card Number 
#define S_TCCHECKF_TRANSCODE    0x04        // Trans Code
#define S_TCCHECKF_ID_NO        0x08        // ID Number
#define S_TCCHECKF_BIRTHDATE    0x10        // Birthdate MMDDYY
#define S_TCCHECKF_PHONE_NO     0x20        // Phone number
#define S_TCCHECKF_ZIPCODE      0x40        // Zip Code
#define S_TCCHECKF_STATECODE    0x80        // State Code

//		FOR THIRD ELEMENT OF ARRAY

#define S_TCCHECKF_UNUSED1      0x01        // Unused
#define S_TCCHECKF_UNUSED2      0x02        // Unused
#define S_TCCHECKF_UNUSED3      0x04        // Unused
#define S_TCCHECKF_LASTNAME     0x08        // Last Name
#define S_TCCHECKF_PAYROLLCHK   0x10        // Payroll check
#define S_TCCHECKF_SOC_SEC_NO   0x20        // Social Security number
#define S_TCCHECKF_GRNT         0x40        // Guarantee 
#define S_TCCHECKF_CHK_NO_IFMAN 0x80        // Check Number If Manual

//
//       THE FOLLOWING OPTIONS APPLY TO TCSNMPOPT
//

#define TCSNMP_ENABLE	        0x01	    // SNMP Enable
#define TCSNMP_LISTEN			0x02	    // Listen SNMP Port
#define TCSNMP_ACCESS			0x04	    // Read Write Access
#define TCSNMP_CLEAR_WRITEBLE	0x08	    // Clear writeble Objects
#define TCSNMP_CLEAR_COUNTERS	0x10	    // Clear counters

#define TC9_PRTAUDIT            0x01        // Print Audit Report Before Settlement
#define TC9_PRTSUMM             0x02        // Print Summary Report After Settlement
#define TC9_RESERVED1	        0x04        // 
#define TC9_RESERVED2	        0x08        // 
#define TC9_RESERVED3           0x10        // 
#define TC9_RESERVED4	        0x20        // 
#define TC9_RESERVED5           0x40        // 
#define TC9_RESERVED6           0x80        // 
...
#define S_TCAPPCAP              3
#define S_TCCOMMUNITY           22
#define S_TCRETAINTIME		    3
#define S_TCSOCTIME             4
#define S_TCPRITSPNUM           10
#define S_TCPSECSPNUM           10
#define S_TCPRITCPIP            21
#define S_TCSECTCPI             21
#define S_TCAPPENV              1
#define S_TCSPARE               27
...
struct termconf_rec
{
	...
	UBYTE TCSNMPOPT;					                            // SNMP options 
	UBYTE TCRETAINTIME  [S_TCRETAINTIME];	                        // Retain Link time (in seconds)
	UBYTE TCCOMMUNITY   [S_TCCOMMUNITY];	                        // Community 
	UBYTE TRAP_DEST1_IP_TAB_ID;			                            // Trap Destination 1 IP TAB ID
	UBYTE TRAP_DEST2_IP_TAB_ID;			                            // Trap Destination 2 IP TAB ID
    UBYTE TCSOCDAY;
    UBYTE TCSOCTIME     [S_TCSOCTIME];
    UBYTE TCPRITSPNUM   [S_TCPRITSPNUM];
    UBYTE TCSECTSPNUM   [S_TCPSECSPNUM];
    UBYTE TCPRITCPIP    [S_TCPRITCPIP];
    UBYTE TCSECTCPI     [S_TCSECTCPI];
    UBYTE TCOPT8;
    UBYTE TCINSNUMBER;                                              // INS.NUMBER
    UBYTE TCSPARE       [S_TCSPARE];
...
//###########################################################
// @ydeniz -- BC {
// terminalin yeteneklerinin bulunduðu tablodur. 
#define TCAPMAX      1 

// terminal izinleri - 
#define TCPO_FORCESETTLEMENT        0x01    // günsonuna zorla
#define TCPO_RSV1                   0x02    // 
#define TCPO_TRANINS                0x04    // Tüm satýþ iþlemleri taksitli // All Transactions with installment
#define TCPO_DEFINS                 0x08    // Varsayýlan Taksit            // USe Default Installment Number
#define TCPO_RSV4                   0x10    //
#define TCPO_RSV5	                0x20    //
#define TCPO_RSV6                   0x40    // 
#define TCPO_RSV7                   0x80    // 

#define TCP_DONTSENDREVERSAL        0x01    // reversal gönderme
#define TCP_LIMITTRYREVERSAL        0x02    // reversal gönderme limiti  // Reserval Try Count

struct termcapability_rec
{    
    UBYTE TCPOOP1;              // permissin options 1 
    UBYTE TCACTDT1      [4];	// Activation Date 1                            ; A_Date1               // First Activation Date
    UBYTE TCACTDT2      [4];	// Activation Date 2                            ; A_Date2               // Second Activation Date
    UBYTE TCCURCD1      [3];	// Currency Code 1                              ; Curr_Code1            // Currency Code    (First Activation)
    UBYTE TCCURSIGN1    [3];	// Currency Symbol 1                            ; CurSign1              // Currency Symbol  (First Activation)
    UBYTE TCCURCD2      [3];	// Currency Code 2                              ; Curr_Code2            // Currency code    (Second Activation)
    UBYTE TCCURSIGN2    [3];	// Currency Symbol 2                            ; CurSign2              // Currency Symbol  (Second Activation)
    UBYTE TCPDEFINS;            // varsayýlan taksit adedi                      ; Default_In            // Default Installment Number
    UBYTE TCPMININS;            // minimum taksit adedi                         ; Min_Ins               // Min Installment Number
    UBYTE TCPMAXINS;            // maksimum taksit adedi                        ; Max_Ins               // Max Installment Number
    UBYTE TCPSALEMAXDIS [2];    // satiþ iþlemi için maksimum indirim oraný     ; sale_dis1 + sale_dis2 // Max Discount Ratio For Sale
    UBYTE TCPINSMAXDIS  [2];    // taksitli iþlemi için maksimum indirim oraný  ; ins_dis1 + ins_dis2   // Max Discount Ratio For Installment
    UBYTE TCAPPEXPDT    [3];    // APPLICATION EXPIRY DATE                                              // Old Application Expire Date
    UBYTE TCAPPDELDT    [3];    // APPLICATION DELETION DATE                                            // Old Application Valid Date
    UBYTE TCPOPP2;              //                                              
    UBYTE TCPREVTRYCOUNT;       // reversal try count;                                                  // Reversal Try Count

} __attribute__((packed));

#define TCAPSZE sizeof(struct termcapability_rec)	// DEFINE STRUCTURE SIZE

// End of TERMINAL CAPABILTY ---------------------------------------------------------------------
...
#define CR2_SPARE4		0x10	        // IT 4-SPARE
...
#define IS1_PPADACCSEL      0x01    // PIN Pad Acct Select @erd
...
#define IS2_GUESTPRCS       0x20    // BE MY GUEST PROCESSING
...
//#define IS3_NOMAILORDER     0x01	// VOIDS ARE BLOCKED
...
#define IS4_AUTHOVRLIM      0x04    // Auth. Over Floor Limit @erd
#define IS4_INSBLOK         0x08    // Installment @ydeniz 
#define IS4_TRK1ERR         0x10	// IGNORE TRACK 1 ERROR
#define IS4_TAX             0x20	// PROMPT FOR TAX AMOUNT
//#define IS4_RESERVED        0x20	// 
...
#define IS6_UNUSED          0x40    // Unused @erd
#define IS6_ERC			    0x80	// ELECTRONICALLY CAPTURE RECEIPT

#define IS9_PREBLOK         0x01	// Provizyon Ýþlemi Bloke
#define IS9_CLPREBLOK       0x02	// Önprovizyon Kapama Ýþlemi Bloke
#define IS9_RSV1            0x04	// 
#define IS9_RSV2	        0x08  	//
#define IS9_RSV3	        0x10  	// 
#define IS9_RSV4            0x20	// 
#define IS9_RSV5            0x40    // 
#define IS9_RSV6	        0x80	// 
...
//#define ISPIN_BALINQ      0x08	// ADJUST
//#define ISPIN_RSV           0x20	// BALANCE INQUIRYDrd
#define ISPIN_PREAUTH       0x40    // Pre-auth 
#define ISPIN_CLOSEDPREAUTH 0x80    // Closed Pre-authorization  @erd
...
struct issuer_rec
{
    ...
    // Added by MSD @ 31.12.2007
    // begin MSD
    UBYTE ISFININST[3];
    UBYTE ISHOSTID;
    UBYTE ISMAGFLOOR[3];
    UBYTE ISCHIPLOOR[3];
    UBYTE ISMAXPURCHAM[3];
    UBYTE ISMINPURCHAM[3];
    UBYTE ISMAXCSHBKAM[3];
    UBYTE ISMAXCSHADAM[3];

    UBYTE ISOPT7;
    UBYTE ISOPT8;
    // end MSD
    UBYTE ISOPT9;				        // OPTION BYTE 9
	//UBYTE ISRESV        [25];           // RFU
...
#define AQ1_AMEX_ACQ            0x01        // Amex Acquirer  
#define AQ1_SPDH_ACQ            0x02        // SPDH Acquirer
#define AQ1_APACS_ACQ           0x04        // APACS40 Acquirer
#define AQ1_NOTIME              0x08	    // IGNORE HOST TIME
#define AQ1_SSLTRAN		        0x10	    // USE SSL AUTHETICATION DURING TRANSACTIONS COMMUNICATIONS	
#define AQ1_SSLSETTLE	        0x20	    // USE SSL AUTHETICATION DURING SETTLEMENT COMMUNICATIONS	
#define AQ1_COMMNAME_TRAN	    0x40	    // USE AUTHETICATION COMMON NAME FOR TRANSACTION
#define AQ1_COMMNAME_SETTLE	    0x80	    // USE AUTHETICATION COMMON NAME FOR SETTLEMENT
...
#define AQ2_PRTCHK              0x04        // Parity Checking @erd
#define AQ2_PRNTVISAID          0x08        // Print VISA II Merchant Id @erd
...
#define AQ2_ICC_ACQ             0x80        // ICC (EMV) Acquirer @erd
...
#define AQ3_RSTKEYREG           0x02        // Reset Key Register @erd
...
#define AQ3_ACHCHECK            0x10        // ACH Check @erd
#define AQ3_ERC_COMP            0x20        // ERC Compression @erd
#define AQ3_UPDISSPHN           0x40        // Update ISS Referral Phone @erd
#define AQ3_NET_TRNS            0x80        // Internet Transaction @erd

#define	AQ4_USEIP               0x01		// Use IP communications (instead of dial)
...
#define AQ5_DBPHONE1			0x04		// Dial backup for 1 phone 
#define AQ5_DBPHONE2			0x08		// Dial backup for 2 phone 
#define AQ5_SETTLE_DBPHONE1		0x10		// Dial backup for 1 settlement phone 
#define AQ5_SETTLE_DBPHONE2		0x20		// Dial backup for 2 settlement phone 
#define AQ5_LOGON_DBPHONE1		0x40
#define AQ5_LOGON_DBPHONE2		0x80
...
struct acquirer_rec
{
    ...
    UBYTE AQ_LOGON_P_IPTAB;		                // Primary Transaction IP table index
    UBYTE AQ_LOGON_P_CON;		                // Primary Logon IP connection time
    UBYTE AQ_LOGON_S_IPTAB;		                // Primary Transaction IP table index
    UBYTE AQ_LOGON_S_CON;		                // Secondary Transaction IP connection time
	...
	UBYTE AQRESV[15];                           // RFU
    PS_DIAL_STRUCT logonTrans;	
    UBYTE AQLOGONPMODEM;				        // MODEM MODE FOR LOGON TRANSACTION
    UBYTE AQLOGONSMODEM;				        // MODEM MODE FOR LOGON TRANSACTION
    UBYTE AQLOGONPPPMODE1;			            // PPP mode for 1 phone number in logon trn.
	UBYTE AQLOGONPPPMODE2;			            // PPP mode for 2 phone number in logon trn.	
    ...
    UBYTE AQAQPANMAX;
    UBYTE AQAQSPDHOPT;
    UBYTE AQCUSTREFNUM[4];
    UBYTE AQCUADDRESS[3];
    UBYTE AQ_OPT7;
                                                // 
    //UBYTE AQ_TRIPLE_DESKEY1[S_DESKEY];          // Working Key 1
    //UBYTE AQ_TRIPLE_DESKEY2[S_DESKEY];          // Working Key 2 
} __attribute__((packed));

#define AQSZE sizeof(struct acquirer_rec)	// DEFINE STRUCTURE SIZE

// End of ACQUIRER TABLE ENTRY -----------------------------------------------------------------
...
// End of DESCRIPTOR TABLE ENTRY -----------------------------------------------------------------

//##################################################
//#      IDLE SCREEN BUTTONS STRUCTURE             #
//##################################################
...
// End of IDLE SCREEN BUTTONS TABLE ENTRY -----------------------------------------------------------------

//##################################################
//#      LOCAL VALUES STRUCTURE                    #
//##################################################
...
// End of LOCAL VALUES TABLE ENTRY -----------------------------------------------------------------
...
#define TS2_READIDLE	0x08		// idledan okunarak geldiyse 

#define TS2_FALLBACK        0x20        // Performing ICC Fallback
#define TS2_RSV1            0x40        // 
#define TS2_LOYALTYFBCK	    0x80	// loyalty fallback , puanlý iþlemlerde fallback 
...
#define TROPTEMV_INFADV		0x01		//@pl INFORMATIVE EMV ADVICE
#define TROPTEMV_NOSIG		0x02		//@pl SIGNATURE IS NOT REQUIRED
#define TROPTEMV_CARDDEC        0x10

#define S_TRDISCRATIO           2

// TRLOYALTYSTATUS
#define TS_DISCOUNT         0x01     // indirimli iþlem 
#define TS_POINT            0x02     // puanlý iþlem 
#define TS_ALLPOINT         0x04     // puanýn tamamý kullanýldýysa 
#define TS_ONUSCARD         0x08     // kart kendi kartý ise hostan puan bilgisi döner 

// TRFLAG
#define TR_PINFLAG          0x01     // pin kullanýlarak iþlem yapýldý 
#define TR_HASPOINT         0x02     // puan bilgisi var   
...
struct trandata_rec
{
    ...
    UBYTE       TRCODE[3];		        // Transaction Code     @ydeniz - BC 
    UBYTE       TRINSTNUM;                      // INSTALLMENT NUMBER	@ydeniz - BC 
#ifdef MAKE_EMV
...
/*	###################################################### */
    ...
    UBYTE       TROPTEMV;				//@A -BC  EMV OPTIONS BYTE
    UBYTE       CHIPUSED;                  // @Aydeniz - EMV haricindeki transactionlarda BKTye özgü chipten track2 okumasý
#endif 

    UBYTE TRSRC[S_TRSRC];			// Transaction Source String -- BC slip 
    UBYTE TRCARDTYPE[S_TRCARDTYPE];             // Transaction Card Type -- BC slip 
#ifdef MAKE_KIB
    UBYTE TRLOYALTYSTATUS;                        // Puan kullanýlarak yapýlan transactionlar için kullanýlýr 
    UBYTE TRUSEDLOYALTYAMOUNT[S_TRTOTAM];         // Kullanýlan puan tutarý
    UBYTE TRTOTAMAFTPOINT[S_TRTOTAM];             // puan kullanýldýktan sonraki tutar 
    UBYTE TRDISCOUNTTOTAM[S_TRTOTAM];             // Yapýlan indirim tutarý 
    UBYTE TRTOTAMAFTDISCOUNT[S_TRTOTAM];          // indirim yapýldýktan sonraki tutar
    UBYTE TRDISCOUNTRATIO[S_TRDISCRATIO];         // indirim oraný 
#endif
    ...
    UBYTE TRCOUNTRYCODE[2];                    // transaction code
    UBYTE TRMERCHCATCODE[2];                   // merchant category code
#endif	// MAKE_EMV
        
    UBYTE TRFLAG;                               // Batchte saklanýlmasý istenmeyen statü flagleri     
    UBYTE AVAIL_LOYALTY_AMT[S_TRTOTAM];         // Kullanýlabilen puan tutarý ( host tarafýndan yollanýlýr ) 
} __attribute__((packed));
...
// End of TRANSACTION DATA ENTRY -----------------------------------------------------------------

//##################################################
//#      IS8583 TABLE  STRUCTURE                   #
//##################################################
...
#define S_TOTRFCNT      2
#define S_TOTRFAMT      6
#define S_TOTRFVCNT     2
#define S_TOTRFVAMT     6

#define S_TOTDBRFCNT    2
#define S_TOTDBRFAMT    6
#define S_TOTDBRFVCNT   2
#define S_TOTDBRFVAMT   6

#define S_TOTAUTCNT     2
#define S_TOTAUTAMT     6
#define S_TOTAUTVCNT    2
#define S_TOTAUTVAMT    6

#define S_TOTPAYCNT     2
#define S_TOTPAYAMT     6
#define S_TOTPAYVCNT    2
#define S_TOTPAYVAMT    6

#define S_TOTAUTRFCNT   2
#define S_TOTAUTRFAMT   6
#define S_TOTAUTRFVCNT  2
#define S_TOTAUTRFVAMT  6

struct basictotals_rec
{
    UBYTE TOTDBCNT[S_TOTDBCNT];             // DEBITS COUNT  -- debit sale 
	...
	UBYTE TOTCRCNT[S_TOTCRCNT];             // CREDITS COUNT  -- captured sale 
    ...
    UBYTE TOTRFCNT[S_TOTRFCNT];             // REFUND COUNT  -- capture refund 
	UBYTE TOTRFAMT[S_TOTRFAMT];	            // REFUND AMOUNT
	UBYTE TOTRFVCNT[S_TOTRFVCNT];	        // VOIDED REFUND COUNT
	UBYTE TOTRFVAMT[S_TOTRFAMT];	        // VOIDED REFUND AMOUNT

    UBYTE TOTDBRFCNT[S_TOTDBRFCNT];         // DEBIT REFUND COUNT -- debit refund 
	UBYTE TOTDBRFAMT[S_TOTDBRFAMT];         // DEBIT REFUND AMOUNT
	UBYTE TOTDBRFVCNT[S_TOTDBRFVCNT];       // DEBIT VOIDED REFUND COUNT
	UBYTE TOTDBRFVAMT[S_TOTDBRFAMT];        // DEBIT VOIDED REFUND AMOUNT     
                   
    UBYTE TOTAUTCNT[S_TOTAUTCNT];           // AUTHORIZE SALE COUNT -- authorize sale 
	UBYTE TOTAUTAMT[S_TOTAUTAMT];           // AUTHORIZE SALE AMOUNT
	UBYTE TOTAUTVCNT[S_TOTAUTVCNT];         // AUTHORIZE SALE VOIDED COUNT
	UBYTE TOTAUTVAMT[S_TOTAUTAMT];          // AUTHORIZE SALE VOIDED AMOUNT   
        
    UBYTE TOTPAYCNT[S_TOTPAYCNT];           // PAYMENT COUNT -- payment 
	UBYTE TOTPAYAMT[S_TOTPAYAMT];           // PAYMENT AMOUNT
	UBYTE TOTPAYVCNT[S_TOTPAYVCNT];         // PAYMENT VOIDED COUNT
	UBYTE TOTPAYVAMT[S_TOTPAYAMT];          // PAYMENT VOIDED AMOUNT  

    UBYTE TOTAUTRFCNT[S_TOTAUTRFCNT];       // AUTHORIZE REFUND SALE COUNT -- authorize refund sale 
	UBYTE TOTAUTRFAMT[S_TOTAUTRFAMT];       // AUTHORIZE REFUND SALE  AMOUNT
	UBYTE TOTAUTRFVCNT[S_TOTAUTRFVCNT];     // AUTHORIZE REFUND SALE VOIDED COUNT
	UBYTE TOTAUTRFVAMT[S_TOTAUTRFAMT];      // AUTHORIZE REFUND SALE VOIDED AMOUNT
} __attribute__((packed));
...
struct totals_rec
{
    ...
    // @Aydeniz - BC -- Raporlarda kullanýlmak üzere 
    UBYTE TOTSALCNT[S_TOTCNT];		    // Sale Count
	UBYTE TOTSALAMT[S_TOTAMT];		    // Sale AMOUNT
	UBYTE TOTSALVCNT[S_TOTCNT];		    // VOIDED Sale COUNT
	UBYTE TOTSALVAMT[S_TOTAMT];		    // VOIDED Sale AMOUNT
        
    UBYTE TOTDEBCNT[S_TOTCNT];		    // Debit Sale Count
	UBYTE TOTDEBAMT[S_TOTAMT];		    // Debit Sale AMOUNT
	UBYTE TOTDEBVCNT[S_TOTCNT];		    // VOIDED Debit Sale COUNT
	UBYTE TOTDEBVAMT[S_TOTAMT];		    // VOIDED Debit Sale AMOUNT

    UBYTE TOTINSCNT[S_TOTCNT];		    // installment COUNT
	UBYTE TOTINSAMT[S_TOTAMT];		    // installment AMOUNT
	UBYTE TOTINSVCNT[S_TOTCNT];		    // VOIDED installment COUNT
	UBYTE TOTINSVAMT[S_TOTAMT];		    // VOIDED installment AMOUNT
        
    UBYTE TOTMAILCNT[S_TOTCNT];		    // mailorder COUNT
	UBYTE TOTMAILAMT[S_TOTAMT];		    // mailorder AMOUNT
	UBYTE TOTMAILVCNT[S_TOTCNT];        // VOIDED mailorder COUNT
	UBYTE TOTMAILVAMT[S_TOTAMT];        // VOIDED mailorder AMOUNT

    UBYTE TOTREFCNT[S_TOTCNT];		    // refund COUNT
	UBYTE TOTREFAMT[S_TOTAMT];		    // refund AMOUNT
	UBYTE TOTREFVCNT[S_TOTCNT];		    // VOIDED refund COUNT
	UBYTE TOTREFVAMT[S_TOTAMT];		    // VOIDED refund AMOUNT

    UBYTE TOTPRECNT[S_TOTCNT];		    // preauth COUNT
	UBYTE TOTPREAMT[S_TOTAMT];		    // preauth AMOUNT
	UBYTE TOTPREVCNT[S_TOTCNT];		    // VOIDED preauth COUNT
	UBYTE TOTPREVAMT[S_TOTAMT];		    // VOIDED preauth AMOUNT
        
    UBYTE TOTCPRECNT[S_TOTCNT];		    // closed preauth COUNT
	UBYTE TOTCPREAMT[S_TOTAMT];		    // closed preauth AMOUNT
	UBYTE TOTCPREVCNT[S_TOTCNT];		// VOIDED closed preauth COUNT
	UBYTE TOTCPREVAMT[S_TOTAMT];		// VOIDED closed preauth AMOUNT

    UBYTE TOTDEBITCNT[S_TOTCNT];        // taksit+satis+nakit+mail+offline
	UBYTE TOTDEBITAMT[S_TOTAMT];
        
    UBYTE TOTCREDITCNT[S_TOTCNT];       // taksit iade +satis iade +payment
	UBYTE TOTCREDITAMT[S_TOTAMT];        
} __attribute__((packed));
...
//--------------------------------------------------------------------------------------------------------------------
//##################################################
//#        SETTLE TOTALS STRUCTURE                 #
//##################################################


// hosttan dönen settlement toplamlar
#define S_CNT       3
#define S_AMT       6

struct settletotals_rec
{
	UBYTE TOTALCNT[S_CNT];          // Total count 
    UBYTE TOTALAMT[S_AMT];          // Total amount 
	UBYTE NETCNT[S_CNT];            // Net count 
	UBYTE NETAMT[S_AMT];            // Net amount 
    UBYTE DMCRCNT[S_CNT];           // Domestic Credit count 
    UBYTE DMCRAMT[S_AMT];           // Domestic Credit amount 
    UBYTE INTVISACRCNT[S_CNT];      // International Visa Credit count
    UBYTE INTVISACRAMT[S_AMT];      // International Visa Credit amount
    UBYTE INTEUROCRCNT[S_CNT];      // International Euro Credit count
    UBYTE INTEUROCRAMT[S_AMT];      // International Euro Credit amount
    UBYTE DMDBCNT[S_CNT];           // Domestic Debit count 
    UBYTE DMDBAMT[S_AMT];           // Domestic Debit amount
    UBYTE INTDBCNT[S_CNT];          // International Debit count 
    UBYTE INTDBAMT[S_AMT];          // International Debit amount
    UBYTE SALECNT[S_CNT];           // Sale count 
    UBYTE SALEAMT[S_AMT];           // Sale amount
    UBYTE REFUNDCNT[S_CNT];         // Refund count 
    UBYTE REFUNDAMT[S_AMT];         // Refund amount
    UBYTE VOIDCNT[S_CNT];           // Void count 
    UBYTE VOIDAMT[S_AMT];           // Void amount
    UBYTE PAYCNT[S_CNT];            // Payment count 
    UBYTE PAYAMT[S_AMT];            // Payment amount
} __attribute__((packed));

#define SETTOTSZE sizeof(struct settletotals_rec)	// DEFINE STRUCTURE SIZE
...
struct mib_trans_table
{
	int mibTotalTrans;		// Transaction totals
	int mibTotalOnlineSale; // Total Sale On Line
	int mibTotalOfflineSale;// Offlinbe Sale
	int mibTotalRefund;		// Total refund
	int mibTotalAuth;		// Total preAuth
	int mibTotalAdjSale;	// Total AdjustSale
	int mibManualEntrys;	// Transaction manual entries
};
