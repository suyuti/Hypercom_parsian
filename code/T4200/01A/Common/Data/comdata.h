...
#define FLG_NEEDSETTLE      0x01                    // günsonu yapýlmalý 
#define FLG_NEEDINIT        0x02                    // parametre yüklenmeli 
#define FLG_INIT            0x04                    // hemen init yapýlmalý 
...
// Super Variables
extern UBYTE SUPERFMT;
extern struct super_variables SUPER_VARIABLES_TAB;
extern UBYTE SUPERLRC;
    ...
    extern UBYTE CERT_HASH[SM_HASH_LEN];                // SSL certificate
    #ifdef	MAKE_EMV
...
// MIB Data
extern UBYTE MIBTRANSFMT;
extern struct mib_trans_table MIBTRANSTAB;   
extern UBYTE MIBTRANSLRC;


// son günsonu raporu basýmý 
extern struct settletotals_rec TEMPSETTLE;            // Terminal Totals
extern struct settletotals_rec LASTSETTLE;            // Terminal Totals

// field 63 tag 42
extern UBYTE flagTag42;
extern UBYTE TempInitNo[S_AQPSTEL];

// son parametre yükleme 
extern UBYTE LastInitDate[RTCLEN];

// reversal deneme sayýsý flagi 
extern UBYTE revTryCount;

// flag 
extern UBYTE flagTheFirst[2];
//=============================================================================
