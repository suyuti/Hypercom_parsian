...
// Application's custom font definition (for display)
#ifdef MAKE_FARSI
#include "..\..\T4200\Farsi\Farsi_dspFont_06BN08.h" 
#endif
...
#elif ( DEFAULT_LANGUAGE == 5 ) && defined( MAKE_FARSI )
    #define LNG_DEFAULT LNG_FA
#else
...
#ifdef MAKE_FARSI
//-----------------------------------------------------------------------------
//! Farsi printer remap table
//-----------------------------------------------------------------------------
const UBYTE Farsi_Remap_Tbl[] = 
{
//!  Char code from              Char will be printed instead.
//!  text "pcl" file             See real printer character set
//!                              using Fun_82/Character Map
