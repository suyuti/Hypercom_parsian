...
const char *const FarsiMessages[] = {
	...
	"\xFF\xF4\xC3\xD7\xEB\xE6\x20\x9C\xB1\x93\xDA",                                 // ExpiredCard
    "",																				// PrevalidCard @@@@
	"\x9F\xB7\xF4\xEA\x20\xB2\x93\xA5\xE6\x20\xF5\x9E\xB6\xAF\x20\xAF\xED\xB1\xED",	// NoManEntry
    "\x4D\x4D\x59\x59\x20\xFF\x93\xC3\xD7\xEA\x91\x20\xAE\xF3\xB1\x93\x9D",			// ExpireDate
	...
	"\xAF\xF4\xF4\xFF\x9D\x20\xB1\xC8\x9E\xEB\xE6",									// WaitApprov @@@@
	...
	"ENTER INVOICE NUMBER",															// EnterInvNum //Note:  Must be re-translated shorter.
	"",                                                                             // EnterSOCNum
	"",																				// EnterPONum
	"",                                                                             // MercFunction
	...
	"\xFF\xAA\xF4\xAA\xBE",                                                         // CorrectYesNo
	...
	"",                                                                             // DuplicateTrans
	"\xFF\xAF\xED\xBA\x20\xF1\xD2\x93\xC2\x91",                                     // AddYesNo
	...
	"\xAF\xBA\x20\xAF\xF4\xF4\xFF\x9D\x20\xB4\xBC\xEB\xDA\x91\xB1\x9D",				// TransAccepted
	...
	"INV. NUMBER MISSING",															// InvNumberMissing //Note:  Must be re-translated shorter.
	...
	"\xFF\xAF\xED\xBA\x20\xE1\x93\xCB\xD2",                                         // EnablePP
	"\xFF\xAF\xED\xBA\x20\xE1\x93\xCB\xD2\xB1\xF4\xCE",                             // DisablePP
	"",                                                                             // ScanningBatch
	"",                                                                             // NoBatchTotals
	"",                                                                             // NoMoreTotals
	...
	"\xAF\xF4\xF4\xFF\x9D",                                                         // N_Auth
	"\x9C\xB1\x93\xDA\x20\xAF\xF4\xF4\xFF\x9D",                                     // N_CardVer
	...
	"\x9C\x93\xF4\xFF\xB2\xA5",                                                     // N_Detail
	...
	"\xAF\xF4\xF4\xFF\x9D\x20\xAF\xDA\x20\xAF\xED\xB1\xED",                         // N_EnterAuth
	"",                                                                             // N_EnterGenNum
	"",                                                                             // JournalTesting
	...
	"\xAF\xF4\xF4\xFF\x9D\x20\xB1\xC8\x9E\xEB\xE6",									// WaitingForApproval
	...
	"",                                                                             // N_CVV2Entry
	"\xFF\x9E\xB6\x91\x20\xAF\xED\xA8\xED\xE6\x20\x9C\xB1\x93\xDA",                 // Msg_CardPresent
	...
	"",																				// CallAuthCentre
	"\xFF\x20\xAF\xF4\xF4\xFF\x9D\x20\xAF\xDA",										// AuthCode
