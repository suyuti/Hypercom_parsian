...
//!
//!  \note
//!     This function must be in the same page as
...
//!
//!  \note
//!     This function must be in the same page as adjust and review transactions.
//!
//-----------------------------------------------------------------------------
...
//-----------------------------------------------------------------------------
//!  \brief
//!     Get and save the Close TAb Base Amount.
//!
//!  \param
//!     None
//!
...
//-----------------------------------------------------------------------------
//!  \brief
//!     Get and save the Close Tab Bar Amount.
//!
//!  \param
//!     None
//!
...
//-----------------------------------------------------------------------------
//!  \brief
//!     Get and save the Close Tab Tax Amount.
//!
//!  \param
//!     None
//!
...
//-----------------------------------------------------------------------------
//!  \brief
//!     Get and save the Close Tab Tip Amount.
//!
//!  \param
//!     None
//!
...
static Bool InputCtabTip( void )
{
	...
	do
	{
		...
		do
		{
			...
			switch ( AmountEntry( &AmtEntry, 1, 0 ) )
			{
				case 1:		// See if a non-blank Tip was entered 
					if ( Dspbuf[0] )
					{
