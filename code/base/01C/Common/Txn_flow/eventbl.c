...
const struct event_entry EVENT_TABLE[] = {
 ...
 // {
    {
     SET_TMCOMPARAM,			// Transaction Key
     SetTMComParam,	            // Action handler
     "",						// Transaction name
     0,				            // OPTION BYTE 1
     0,							// OPTION BYTE 2
     0,			            	// OPTION BYTE 3
    ...
    {
     SET_TM_PHONENUMBER,			// Transaction Key
     SetTMPhoneNumber,	            // Action handler
     "",						// Transaction name
     0,				            // OPTION BYTE 1
     0,							// OPTION BYTE 2
     0,			            	// OPTION BYTE 3
    ...
    {
     SET_TM_CONNECTTIME,			// Transaction Key
     SetTMConnectTime,	            // Action handler
     "",						// Transaction name
     0,				            // OPTION BYTE 1
     0,							// OPTION BYTE 2
     0,			            	// OPTION BYTE 3
    ...
    {
     SET_TM_DIALATTEMPT,			// Transaction Key
     SetTMDialAttemp,	            // Action handler
     "",						// Transaction name
     0,				            // OPTION BYTE 1
     0,							// OPTION BYTE 2
     0,			            	// OPTION BYTE 3
    ...
    {
     SET_TM_MODEMMODE,			// Transaction Key
     SetTMModemMode,	            // Action handler
     "",						// Transaction name
     0,				            // OPTION BYTE 1
     0,							// OPTION BYTE 2
     0,			            	// OPTION BYTE 3
    ...
    {
     SET_TM_PPPMODE,			// Transaction Key
     SetTMPPPMode,	            // Action handler
     "",						// Transaction name
     0,				            // OPTION BYTE 1
     0,							// OPTION BYTE 2
     0,			            	// OPTION BYTE 3
    ...
    {
     SET_TM_IPDDRESS,			// Transaction Key
     SetTMIpAddress,	            // Action handler
     "",						// Transaction name
     0,				            // OPTION BYTE 1
     0,							// OPTION BYTE 2
     0,			            	// OPTION BYTE 3
    ...
    {
     SET_TM_PPPENABLE,			// Transaction Key
     PPPModeEnabled,	            // Action handler
     "",						// Transaction name
     0,				            // OPTION BYTE 1
     0,							// OPTION BYTE 2
     0,			            	// OPTION BYTE 3
    ...
    {
     SET_TM_COMTYPE,			// Transaction Key
     SetTMComParam,	            // Action handler
     "",						// Transaction name
     0,				            // OPTION BYTE 1
     0,							// OPTION BYTE 2
    ...
    {
     SET_TM_IPPORT_NUMBER,			// Transaction Key
     SetTMIpPort,	            // Action handler
     "",						// Transaction name
     0,				            // OPTION BYTE 1
     0,							// OPTION BYTE 2
     0,			            	// OPTION BYTE 3
    ...
    {
     SET_TM_IPNII,			// Transaction Key
     SetTMIpNII,	            // Action handler
     "",						// Transaction name
     0,				            // OPTION BYTE 1
     0,							// OPTION BYTE 2
     0,			            	// OPTION BYTE 3
    ...
    {
     SET_TM_IPHEXLEN,			// Transaction Key
     HexLenInHeaderEnabled,	            // Action handler
     "",						// Transaction name
     0,				            // OPTION BYTE 1
     0,							// OPTION BYTE 2
     0,			            	// OPTION BYTE 3
    ...
    {
     SET_TM_IPPOSTPDU,			// Transaction Key
     PosTPDUInHeaderEnabled,	            // Action handler
     "",						// Transaction name
     0,				            // OPTION BYTE 1
     0,							// OPTION BYTE 2
     0,			            	// OPTION BYTE 3
    ...
    {
     SET_TM_NII,			// Transaction Key
     SetTMNII,	            // Action handler
     "",						// Transaction name
     0,				            // OPTION BYTE 1
     0,							// OPTION BYTE 2
     0,			            	// OPTION BYTE 3
    ...
    {
     SET_TM_POSTPDU,			// Transaction Key
     SetTMPosTPDU,	            // Action handler
     "",						// Transaction name
     0,				            // OPTION BYTE 1
     0,							// OPTION BYTE 2
     0,			            	// OPTION BYTE 3
