...
UBYTE const IMG_CARD[] = {
    0x59, 0x00,	// Overall length
    0x10, 0x00,	// 16-bit screen id
    0x18, 0x00,	// Image width
    0x1D, 0x00,	// Image height
    0x01,		// Compression type
    0x50, 0x00,	// Data length
    0x82, 0x15, 0xF0, 0x0E, 0xC2, 0x10, 0xE0, 0x11,
    0xE7, 0x11, 0xE7, 0xF0, 0x0A, 0xE7, 0xF8, 0x0A,
    0xE7, 0xF8, 0x0A, 0xE7, 0xF8, 0x0A, 0xE7, 0xF8,
    0x0A, 0xE7, 0xF8, 0x0A, 0xE7, 0xF8, 0x0A, 0xE7,
    0xFB, 0xE0, 0x8C, 0x27, 0x82, 0x81, 0xCE, 0xB0,
    0x90, 0x99, 0xE1, 0xC1, 0x83, 0x9E, 0x84, 0x88,
    0xB3, 0xF8, 0x07, 0xC6, 0xBF, 0xE0, 0x84, 0xA7,
    0x27, 0x08, 0xC1, 0xFE, 0xD0, 0x84, 0x87, 0xE6,
    0x11, 0xF3, 0x0C, 0xF0, 0xEA, 0x0B, 0xE0, 0xE4,
    0x12, 0xF4, 0x12, 0xFC, 0x16, 0xE0, 0x13, 0xEF
};

UBYTE const IMG_ICCCARD[] = {
    0x56, 0x00,	// Overall length
    0x10, 0x00,	// 16-bit screen id
    0x18, 0x00,	// Image width
    0x1D, 0x00,	// Image height
    0x01,		// Compression type
    0x4D, 0x00,	// Data length
    0x82, 0x15, 0xF0, 0x0E, 0xC2, 0x10, 0xF8, 0x11,
    0x27, 0x11, 0x2A, 0x0E, 0xF3, 0xF8, 0x0A, 0xF0,
    0xF8, 0x0A, 0xFC, 0xF8, 0x0A, 0xF3, 0xF8, 0x0A,
    0xF0, 0xF8, 0x0A, 0xFC, 0xF8, 0x0A, 0x2B, 0xBC,
    0x81, 0x2A, 0x82, 0x81, 0xFE, 0xB0, 0x90, 0x9F,
    0xE1, 0xC1, 0x83, 0xFE, 0x84, 0x88, 0xBF, 0xF8,
    0x07, 0xC7, 0x29, 0x09, 0xC7, 0x2A, 0x08, 0xC1,
    0xFE, 0xD0, 0x84, 0x87, 0xE6, 0x11, 0xF3, 0x0C,
    0xF0, 0xEA, 0x0B, 0xE0, 0xE4, 0x12, 0xF4, 0x12,
    0xFC, 0x16, 0xE0, 0x13, 0xEF
};
#else
UBYTE const IMG_CARD[] = {
...
const UBYTE IMG_SELECT[] =
{
    0x1B, 0x00, // Overall length 27
    0x00, 0x00, // 16-bit screen id
    0x10, 0x00, // Image width 16
    0x10, 0x00, // Image height 16
    0x01,   // Compression type
    0x12, 0x00, // Data length 32
    0x40,
    0x2C,
    0xC0,
    0x09,
...
//-----------------------------------------------------------------------------
//! \brief
//!     Gets a pointer to selected image
//!
//! \param
//!		[in]imageID			Id of image to retrieve
//!
//! \return
//!     Pointer to buffer of selected image
//-----------------------------------------------------------------------------
