...
//-----------------------------------------------------------------------------
//!  \brief     Input invoice number or use default from terminal.
//!
//!  \param
//!     None.
//!
...
//-----------------------------------------------------------------------------
//!  \brief      If option set check for duplicate trans in batch.
//!
//!  \param
//!     None.
//!
//!  \return
//!     Bool        True  - Duplicate found and rejected,
//!                 False - otherwise.
//!
//!  \note
//!     If duplicate found, prompts to user to accept.
//!
//-----------------------------------------------------------------------------
Bool InDupCheck(  )
{
...
//-----------------------------------------------------------------------------
//!  \brief     Set up shift number if shift enabled.
//!
//!  \param
//!     None.
//!
...
void InShift( void )
{
	...
	{
		// If shift has not been initialized, initialized it now. 
		if ( !TFTAB.TFSHIFT )
		{
			TFTAB.TFSHIFT = 1;
			SetTFTabLRC(  );
		...
		// Put shift number in TRINP structure.  
		TRINP.TRSHIFT = TFTAB.TFSHIFT;
	}
}


//-----------------------------------------------------------------------------
//!  \brief     Get card or keypad data.
//!
//!  \param
//!     None.
//!
...
//!
//!  \note
//!     Cross-callable like ReadDataPrompt,
...
//-----------------------------------------------------------------------------
//!  \brief     Increment Terminal Invoice Number.
//!
//!  \param
//!     None.
//!
