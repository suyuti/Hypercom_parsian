...
//!	  Enable func		Image				Button label		Event
    ...
    { EnableCashier,    IMAGE_EMPTY,        ReportMenuCashier,  CASHIER_FUN},
    { EnableServer,     IMAGE_EMPTY,        ReportMenuServer,   CASHIER_FUN},
    ...
    { EnableTab,        IMAGE_EMPTY,        N_Tab,              TABPROC_FUN},
    { Check_Exit,       IMAGE_EMPTY,        N_Exit,             EXIT_FUN},
};
...
//!	  Enable func		Image				Button label		Event    
    ...
    { NULL,             IMAGE_EMPTY,        N_SalCash,          SALCASH},
    { NULL,             IMAGE_EMPTY,        RefundTran,         REFUND},
    { NULL,             IMAGE_EMPTY,        N_Force,            SALOFFL},
    { NULL,             IMAGE_EMPTY,        N_Auth,             AUTH},
    { NULL,             IMAGE_EMPTY,        N_Cash,             DBCASH},
    { NULL,             IMAGE_EMPTY,        BalanceTran,        BALINQ},
    { NULL,             IMAGE_EMPTY,        N_CardVer,          CRDVER},
...
//!	  Enable func		Image				Button label		Event
    ...
    { NULL,             IMAGE_EMPTY,        AmountTotals,       TOTALS},
    { NULL,             IMAGE_EMPTY,        N_Find,             FIND},
    { NULL,             IMAGE_EMPTY,        N_Adjust,           ADJUST},
    { NULL,             IMAGE_EMPTY,        N_Void,             VOIDTRAN},
    { NULL,             IMAGE_EMPTY,        Msg_Status,         SETTLE_STATUS_FUN},
};
...
//###	{ NULL,				IMAGE_EMPTY,        N_Initialize,		INITIALIZE },
    ...
    { EnableShift,      IMAGE_EMPTY,        N_Shift,            CHANGESHIFT_FUN},
    { NULL,             IMAGE_EMPTY,        N_View,             MENU_TERMVIEW},
    { NULL,             IMAGE_EMPTY,        N_TrainMode,        TRAINMODE},
    { NULL,             IMAGE_EMPTY,        N_Reset,            RESET_FUN},
    { NULL,             IMAGE_EMPTY,        N_Logon,            LOGON},
    { NULL,             IMAGE_EMPTY,        N_IcePac,           ICEPAK_DOWNLOAD},
};
...
//!	  Enable func		Image				Button label		Event
    { NULL,             IMAGE_EMPTY,        N_ComParameter,     MENU_SET_TMCOMPARAM},
...
//###	{ NULL,				IMAGE_EMPTY,		N_Contras,			SETCONTRAST_FUN},
    { NULL,             IMAGE_EMPTY,        Msg_Tips,           TIPS_FUN},
...
//!	  Enable func		Image				Button label		Event
    ...
    { EnableTill,       IMAGE_EMPTY,        ReportMenuTill,     'A'},
    { EnableCashier,    IMAGE_EMPTY,        ReportMenuCashier,  'B'},
    { EnableServer,     IMAGE_EMPTY,        ReportMenuServer,   'B'},
    { NULL,             IMAGE_EMPTY,        N_Reprint,          'F'},
    { EnableTab,        IMAGE_EMPTY,        ReportMenuOpenTabs, 'E'},
...
//	{ NULL,             IMAGE_EMPTY,        N_Dial,             'D',},
    { EnableTab,        IMAGE_EMPTY,        Msg_Tips,           'T',},
};
