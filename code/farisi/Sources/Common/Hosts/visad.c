...
//-----------------------------------------------------------------------------
//! \brief
//!     Entry point for Visa D host processing
//!
//! \return
//!     None.
//-----------------------------------------------------------------------------
...
//-----------------------------------------------------------------------------
//! \brief
//!     Uploads the batch to Visa D host
//!
//! \return
//!     True if one was sent, Response in TRREQ else False (no more to send)
//-----------------------------------------------------------------------------
static Bool UploadVisaD( void )
{
	OS_RETURN_VALS CommStatus;
...
//-----------------------------------------------------------------------------
//! \brief
//!     Sends the debit confirmation message
//!
//! \return
//!     None
//-----------------------------------------------------------------------------
