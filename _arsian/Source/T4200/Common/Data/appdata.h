...
extern Bool AppFirstRun;        // True if the first application run
...
enum CancelTransactionTypes {
    CancelPreauthType,
    CancelPreauthClosedType,
};

extern UBYTE g_cancelTransactionType;
