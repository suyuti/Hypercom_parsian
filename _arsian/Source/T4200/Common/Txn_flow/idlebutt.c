...
//-----------------------------------------------------------------------------
//!  \brief
//!     Select Idle Button Function (2 functions)
...
static Bool IdleButtonFunc( void )
{
	...
	while ( loop )
	{
		...
		keyfunc = GetOneKey( DEV_KBD | DEV_PAD, UserTimeout );
		switch ( keyfunc )
		{
...
//-----------------------------------------------------------------------------
//!  \brief
//!     Enab/Dis Idle Button Table Init.
//!                               
//!  \param
//!     None
//!
...
//-----------------------------------------------------------------------------
//!  \brief
//!     Start the process to Select button and Event to display
//!                               
//!  \param
//!     None
//!
...
//-----------------------------------------------------------------------------
//!  \brief
//!     Select new Transaction or function to copy into the idle Button Scr
//!                               
//!                               
//!  \param
//!     None
...
//-----------------------------------------------------------------------------
//!  \brief
//!     Select new Transaction to copy into the idle Button Scr
//!                               
//!  \param
//!     None
//!
...
//-----------------------------------------------------------------------------
//!  \brief
//!     Select new function to copy into the idle Button Scr
//!                               
//!  \param
//!     None
//!
//!  \return
//!     Bool        1 - Selection succesfull
...
//-----------------------------------------------------------------------------
//!  \brief
//!     Prompt to confirm an event selection
//!                               
//!  \param
//!     screen      Screen Entry
//!
//!  \return
//!     'Y' - yes selected, go to next step
...
//-----------------------------------------------------------------------------
//!  \brief
//!     Update IBTAB with Button and Event ID previusly selected
//!                               
//!  \param
//!     None
//!
