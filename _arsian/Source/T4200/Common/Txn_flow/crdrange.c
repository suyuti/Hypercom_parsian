...
//-----------------------------------------------------------------------------
//!  \brief
//!     Check if the account number in TRINP is in the card
...
//!
//!  \return
//!     char        1 if acceptable card range, acquirer, & 
//!                 issuer found
//!                 0 if not found
//!  \note
//!     Globals:  The card number is in TRINP.TRPAN in BCD form
//-----------------------------------------------------------------------------
...
//-----------------------------------------------------------------------------
//!  \brief
//!     Choose one of two issuers/acqirers associated with
...
//!
//!  \return
//!     UBYTE       non-zero if Acquirer ID is found
//!                 0 if Acquirer ID is not found
//!
//!  \note
//!     Globals: uses TRINP and CurrentEvent.NEXTEVENT
//-----------------------------------------------------------------------------
static UBYTE CheckIssuerAcquirer( void )
{
