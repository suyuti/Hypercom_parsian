...
static const char F63_I2_Hdr[] = {
    //! BCD length of bit 63 - preliminary
	'\x00', '\x00',
    //! BCD length of I2 tag = 18 bytes constant
	'\x00', '\x18',
    //! 'I2' = All table hash
	'I', '2'
};
...
static const char F63_I1_Hdr[] = {
    //! BCD length of I1 tag - preliminary
	'\x00', '\x00',
    //! 'I1' = Per-table hash
	'I', '1',
    //! BCD counter of tables
	'\x00',
};
...
//-----------------------------------------------------------------------------
//! \brief
//!     Builds an initialization request message
//!
//! \return
//!     Comm Status of Request send
//!
//! \note
