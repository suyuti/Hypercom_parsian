...
static Bool MovInv( void )
{
	...
	{
        // Reversal'da gonderilir.
        if ((TRREQ.TRSTATUS[0] & (TS1_REV)) == (TS1_REV)    ||
            (TRREQ.TRKEY == (PREAUTH))                      ||
            (TRREQ.TRKEY == (CLOSED_PREAUTH))               ||
            (TRREQ.TRKEY == (VOIDTRAN))                     ||
            (TRREQ.TRKEY == (PREAUTHCANCEL))                ||
            (TRREQ.TRKEY == (CLOSEDPAUTHCANCEL))            ||
            (TRREQ.TRKEY == (REFUND)) )
        {
